...
for ireg,reg in enumerate(regressions):
    corrcatpT = CatPlots("Regression Output",[0,50,75,100,150,200,300,600],"Jet_Pt","Jet p_{T}",False,False,"ttHbb",plotbinning[ireg],True)
...
for ireg,reg in enumerate(regressions):
    print reg
    corrcatpT_bkg = CatPlots("Regression Output",[0,50,75,100,150,200,300,600],"Jet_Pt","Jet p_{T}",False,False,"ttbar",plotbinning[ireg],True)
...
# Parton Target
dijet = normPlots("Tagged dijet mass closest to 125 GeV / GeV",True,2,["Without Regression","With Regression"],[40,100,160],True)
...
dijet_all = normPlots("Tagged dijet mass closest to 125 GeV / GeV",True,2,["Without Regression","With Regression"],[40,90,150],True)
...
bestH = normPlots("Best Higgs mass / GeV",True,2,["Without Regression","With Regression"],[40,80,180],True)
...
bestH_all = normPlots("Best Higgs mass / GeV",True,2,["Without Regression","With Regression"],[40,80,180],True)
...
closesdijet = normPlots("Closest tagged dijet mass / GeV",True,2,["Without Regression","With Regression"],[50,30,170],True)
...
closesdijet_all = normPlots("Closest tagged dijet mass  / GeV",True,2,["Without Regression","With Regression"],[50,30,170],True)
...
mcbbmass = normPlots("MC Higgs mass /GeV",True,2,["Without Regression","With Regression"],[40,80,180],True)
...
mcbbmass.WriteHisto(c1,"ttHbb",False,False,pdfout, False, None, False,False,None,True)

del mcbbmass

mcbbmass0lep = normPlots("MC Higgs mass w/ 0 matched Leptons /GeV",True,2,["Without Regression","With Regression"],[40,80,180],True)
...
mcbbmass2lep = normPlots("MC Higgs mass w/ 2 matched Leptons /GeV",True,2,["Without Regression","With Regression"],[40,80,180],True)
...
#GenJet Target
dijet_genJet = normPlots("Tagged dijet mass closest to 125 GeV / GeV",True,2,["Without Regression","With Regression"],[40,100,160],True)
...
dijet_genJet_all = normPlots("Tagged dijet mass closest to 125 GeV / GeV",True,2,["Without Regression","With Regression"],[40,90,150],True)
...
bestH_genjet = normPlots("Best Higgs mass / GeV",True,2,["Without Regression","With Regression"],[40,80,180],True)
...
bestH_genjet_all = normPlots("Best Higgs mass / GeV",True,2,["Without Regression","With Regression"],[40,80,180],True)
...
closesdijet_genjet = normPlots("Closest tagged dijet mass / GeV",True,2,["Without Regression","With Regression"],[50,30,170],True)
...
closesdijet_genjet_all = normPlots("Closest tagged dijet mass  / GeV",True,2,["Without Regression","With Regression"],[50,30,170],True)
...
mcbbmass_genJet = normPlots("MC Higgs mass /GeV",True,2,["Without Regression","With Regression"],[40,80,180],True)
...
mcbbmass_genJet.WriteHisto(c1,"ttHbb",False,False,pdfout, False, None, False,False,None,True)

del mcbbmass_genJet

mcbbmass0lep_genJet = normPlots("MC Higgs mass w/ 0 matched Leptons /GeV",True,2,["Without Regression","With Regression"],[40,80,180],True)
...
mcbbmass2lep_genJet = normPlots("MC Higgs mass w/ 2 matched Leptons /GeV",True,2,["Without Regression","With Regression"],[40,80,180],True)
...
#Targets:
target =  normPlots("Regression Targets",True,2,["Parton p_{T} / Jet p_{T} ","GenJet p_{T} / Jet p_{T}"],[50,0.6,1.6],True)
...
hadtopmass = normPlots("MC Had. Top mass /GeV",True,2,["Without Regression","With Regression"],[80,80,240],True)
...
hadtopmass.WriteHisto(c1,"ttbar",False,False,pdfout, False, None, False,False,None,True)

hadtopmass_genJet = normPlots("MC Had. Top mass /GeV",True,2,["Without Regression","With Regression"],[80,80,240],True)
...
hadtopmass_genJet.WriteHisto(c1,"ttbar",False,False,pdfout, False, None, False,False,None,True)
...
target =  normPlots("Parton p_{T} / Jet p_{T} ",True,2,["t#bar{t}H , H #rightarrow b#bar{b}","t#bar{t}"],[50,0.6,1.6],True)
...
target =  normPlots("GenJet p_{T} / Jet p_{T} ",True,2,["t#bar{t}H , H #rightarrow b#bar{b}","t#bar{t}"],[50,0.6,1.6],True)
target.changeColorlist([ROOT.kViolet+7,ROOT.kSpring-5])
...
dijet_both_all = normPlots("Tagged dijet mass closest to 125 GeV / GeV",True,3,["Without Regression","With Parton Regression","With GenJet Regression"],[40,90,150],True)
...
bestH_both_all = normPlots("Best Higgs mass / GeV",True,3,["Without Regression","With Parton Regression","With GenJet Regression"],[40,80,180],True)
...
closesdijet_both_all = normPlots("Closest tagged dijet mass  / GeV",True,3,["Without Regression","With Parton Regression","With GenJet Regression"],[50,30,170],True)
...
outputvtarget = TwoDplot("Target","Output",[70,0.7,1.3],[60,0.85,1.3],True)
...
outputvtarget = TwoDplot("Target","Output",[40,0.7,1.3],[35,0.85,1.3],True)
outputvtarget.addLabel(0.02,0.025,"Target: Parton p_{T} / Jet p_{T}",0,0.04)
outputvtarget.setAxisTitle("Regression Output","Target ",)
...
outputvtarget = TwoDplot("jetpt","Output",[40,0.7,1.3],[35,0.85,1.3],True)
outputvtarget.addLabel(0.02,0.025,"Target: GenJet p_{T} / Jet p_{T}",0,0.04)
outputvtarget.setAxisTitle("Regression Output","Target ")
outputvtarget.projecttoTwoDplot(tree_sig,"(Jet_regcorr_genJet):(Jet_MatchedGenJetwNuPt / Jet_Pt)","abs(Jet_MatchedPartonFlav) == 5 && Jet_regcorr > 0")
outputvtarget.WriteTwoDplot(c1,"ttHbb",True,None,pdfout,False,False,[0.85,0.85,1.3,1.3])
