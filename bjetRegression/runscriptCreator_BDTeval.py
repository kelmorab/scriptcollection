...
samples=[('ttbar_nominal','/nfs/dust/cms/user/kschweig/JetRegression/trees0908/BDTTraining/ttbar_incl/*_nominal_'),
         ('ttHbb','/nfs/dust/cms/user/kschweig/JetRegression/trees0908/BDTTraining/ttHbb/*_nominal_')]
...
def createScript(scriptname,programpath,processname,filenames,outfilename,maxevents,skipevents,suffix):
    ...
    script+='cd - \n'
    script+='python '+programpath+' '+outfilename+' '+filenames+'\n'
    f=open(scriptname,'w')
    f.write(script)
    f.close()
